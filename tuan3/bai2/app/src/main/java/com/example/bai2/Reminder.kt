        ...
        setContent {
            Bai2Theme {
                ...
                Scaffold(
                    ...
                    ReminderScreen(navController = navController, modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun ReminderScreen(navController: NavController, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier.fillMaxSize(),
        ...
        Row(
            ...
            Text(
                ...
                modifier = Modifier
                    .padding(start = 20.dp)
                    .clickable {
                        navController.navigate("increaseWork")
                    }
            )
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.anh4),
