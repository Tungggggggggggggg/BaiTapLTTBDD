...
class EasyTimeActivity : ComponentActivity() {
        ...
        setContent {
            Bai2Theme {
                ...
                Scaffold(
                    ...
                    EasyTimeScreen(navController = navController, modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun EasyTimeScreen(navController: NavController, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier.fillMaxSize(),
        ...
        Button(
            onClick = { navController.navigate("increaseWork") },
            modifier = Modifier
                .width(250.dp)
...
fun EasyTimePreview() {
    Bai2Theme {
        EasyTimeScreen(navController = rememberNavController())
    }
}
